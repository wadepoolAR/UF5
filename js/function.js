(function ($) {
  ...
  /* Match Highlight Slider JS */
  if ($(".match-highlight-slider").length) {
    const match_highlight_slider = new Swiper(
  ...
  /* Service List Active End */

  /* Approach Item Boxes Active Start */
  var $approach_item_box = $(".approach-item-box");
  if ($approach_item_box.length) {
    var $approach_item = $approach_item_box.find(".approach-item");
  ...
  /* Approach Item Boxes Active End */
